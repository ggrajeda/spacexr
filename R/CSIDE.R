...
#' Runs CSIDE for a single explanatory variable
#'
...
#' Runs CSIDE to detect nonparametric smooth gene expression patterns
#'
...
#' Runs CSIDE for DE across multiple discrete regions
#'
...
#' Runs cell type specific CSIDE for a general design matrix
#'
...
#' Runs CSIDE for a general design matrix
#'
...
#'
#' @param rctd_results a \code{\link[SpatialExperiment]{SpatialExperiment}}
#'   object output by the \code{\link{runRctd}} function.
