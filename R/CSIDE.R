...
#'   internally by CSIDE
#' @export
run.CSIDE.single <- function(rctd_results, explanatory.variable,  cell_types = NULL, cell_type_threshold = 125,
                          gene_threshold = 5e-5, doublet_mode = TRUE, weight_threshold = NULL,
                          sigma_gene = TRUE, PRECISION.THRESHOLD = 0.05, cell_types_present = NULL, fdr = .01,
                          test_genes_sig = TRUE, normalize_expr = FALSE, logs=FALSE, log_fc_thresh = 0.4, test_error = FALSE) {
  ...
  return(run.CSIDE(rctd_results, X2, barcodes, cell_types, gene_threshold = gene_threshold, cell_type_threshold = cell_type_threshold,
...
#' @param logs (default FALSE) if TRUE, writes progress to logs/de_logs.txt
#' @export
run.CSIDE.nonparam <- function(rctd_results, df = 15, barcodes = NULL, cell_types = NULL,
                            cell_type_threshold = 125, gene_threshold = 5e-5, doublet_mode = TRUE,
                            weight_threshold = NULL, sigma_gene = TRUE,
                            PRECISION.THRESHOLD = 0.05, cell_types_present = NULL, fdr = .01, test_genes_sig = TRUE,
                            logs=FALSE, test_error = FALSE) {
  myRCTD <- createCside(rctd_results)
  ...
  return(run.CSIDE(rctd_results, X2, barcodes, cell_types, gene_threshold = gene_threshold,
...
#'  internally by CSIDE
#'@export
run.CSIDE.regions <- function(rctd_results, region_list, cell_types = NULL,
                           cell_type_threshold = 125, gene_threshold = 5e-5, doublet_mode = TRUE,
                          weight_threshold = NULL, sigma_gene = TRUE,
                           PRECISION.THRESHOLD = 0.05, cell_types_present = NULL, fdr = 0.01, test_genes_sig = TRUE,
                          logs=FALSE, log_fc_thresh = 0.4, test_error = FALSE) {
  myRCTD <- createCside(rctd_results)
...
#'   internally by CSIDE
#' @export
run.CSIDE <- function(rctd_results, X, barcodes, cell_types = NULL, gene_threshold = 5e-5, cell_type_threshold = 125,
                          doublet_mode = TRUE, test_mode = 'individual', weight_threshold = NULL,
                          sigma_gene = TRUE, PRECISION.THRESHOLD = 0.05, cell_types_present = NULL,
                          test_genes_sig = TRUE, fdr = .01, cell_type_specific = NULL,
                      params_to_test = NULL, normalize_expr = FALSE, logs=FALSE, log_fc_thresh = 0.4,
                      cell_type_filter = NULL, test_error = FALSE, initialSol = NULL) {
  ...
  if(any(!cell_type_specific))
    ...
    X2 <- X
  return(run.CSIDE.general(rctd_results, X1, X2, barcodes, cell_types, cell_type_threshold = cell_type_threshold, gene_threshold = gene_threshold,
...
#' @export
run.CSIDE.general <- function(rctd_results, X1, X2, barcodes, cell_types = NULL, gene_threshold = 5e-5, cell_type_threshold = 125,
                          doublet_mode = TRUE, test_mode = 'individual', weight_threshold = NULL,
                          sigma_gene = TRUE, PRECISION.THRESHOLD = 0.05, cell_types_present = NULL,
                          test_genes_sig = TRUE, fdr = .01, params_to_test = NULL, normalize_expr = FALSE,
                          logs=FALSE, cell_type_filter = NULL, log_fc_thresh = 0.4, test_error = FALSE, initialSol = NULL) {
  myRCTD <- createCside(rctd_results)
...
get_sig_genes <- function(puck, myRCTD, gene_list_tot, cell_types, my_beta, barcodes, nUMI,
                          ...
                          fdr = .01, p_thresh = 1, log_fc_thresh = 0.4, normalize_expr = FALSE) {
...
get_de_gene_fits <- function(X1,X2,my_beta, nUMI, gene_list, cell_types, puck, barcodes, sigma_init, test_mode,
                             numCores = 4, sigma_gene = TRUE, MIN_CHANGE = 0.001, PRECISION.THRESHOLD = 0.05, params_to_test = 2, initialSol = NULL, logs=FALSE) {
...
fit_de_genes <- function(X1,X2,my_beta, nUMI, gene_list, puck, barcodes, sigma_init, test_mode, numCores = 4, MIN_CHANGE = 1e-3, sigma_gene = TRUE, PRECISION.THRESHOLD = 0.05, initialSol = NULL,
                         logs=FALSE) {
  results_list <- list()
  if(numCores == 1) {
